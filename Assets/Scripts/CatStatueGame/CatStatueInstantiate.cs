...
public class CatStatueInstantiate : MonoBehaviour
{
    ...
    [SerializeField] private float minXPos = -10.0f;
    [SerializeField] private float maxXPos = 10.0f;
    [SerializeField] private float minYPos = -10.0f;
    [SerializeField] private float maxYPos = 10.0f;
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < maxNumber; i++)
        {
            ...
            GameObject obj = Instantiate<GameObject>(catStatue, pos, Quaternion.identity, transform);//objeto, posição, orientação dele e objeto pai do objeto que vamos posicionar
