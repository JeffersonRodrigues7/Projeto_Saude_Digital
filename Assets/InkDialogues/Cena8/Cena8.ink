...
{PLAYER_ACTOR}: Espera! Você...

{PLAYER_ACTOR}: Nossa, já foi.
{PLAYER_ACTOR}: Será que... Foi isso mesmo que eu vi?
...
{A_ACTOR}: Ah, e parece que tem um psicólogo na nossa escola para atender os alunos. Vou conversar com ele.
{PLAYER_ACTOR}: Que legal! Fico feliz em ver as coisas se ajeitando.
{PLAYER_ACTOR}: ...
{A_ACTOR}: {PLAYER_ACTOR}, tá tudo bem?
{PLAYER_ACTOR}: Ahn...? Tá sim, por que?
{A_ACTOR}: Seu rosto. Você parece preocupado.
{A_ACTOR}: Sabe, você tem sido um ótimo amigo.
{A_ACTOR}: Então eu gostaria que me desse a chance de ser um bom amigo para você também.
