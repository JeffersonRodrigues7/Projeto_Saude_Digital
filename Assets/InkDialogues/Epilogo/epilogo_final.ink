...
{ 
- epilogo_points == 100:
    {A_ACTOR}: Okay! Estou muito mais calmo agora!
- epilogo_points >= 50:
    {A_ACTOR}: Acho que isso ajudou um pouco.
- epilogo_points >= 30:
    {A_ACTOR}: É... isso não ajudou em nada.
- else:
    {A_ACTOR}: Parece que no fim das contas eu só consegui ficar ainda pior.
}
...
{A_ACTOR}: Agora eu realmente preciso tentar dormir se quiser estar disposto para a prova amanhã.