...
{PLAYER_ACTOR}: (É... parece que o {A_ACTOR} vai faltar de novo...)  
...
{PROFESSOR_ACTOR}: Seja bem-vinda {B_ACTOR}!
...
{PROFESSOR_ACTOR}: {B_ACTOR}, como eu disse antes, hoje teremos uma prova, mas como é seu primeiro dia não precisa se preocupar. 
...
{PLAYER_ACTOR}: (Parece que {A_ACTOR} realmente não vai vir... de novo).