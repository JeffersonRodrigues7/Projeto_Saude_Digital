...
{PLAYER_ACTOR}: Consegui pegar algo para você comer com o professor Rogério.
{PLAYER_ACTOR}: Ele me deu esse pote cheio de cookies.

{PROFESSOR_ACTOR}: Oi {PLAYER_ACTOR}!
...
{PROFESSOR_ACTOR}: Não acredito que o Rogério se trancou de novo com aquela tranca automática dele.
...
{PLAYER_ACTOR}: Isso é bem a cara do professor Rogério mesmo.

{PROFESSOR_ACTOR}: Aliás {PLAYER_ACTOR}, acho que eu estava te devendo terminar uma explicação.
...
{PLAYER_ACTOR}:  Muito obrigado, professora {PROFESSOR_ACTOR}! 
{PLAYER_ACTOR}:  Acho que você me fez entender mais do que eu esperava. 
 
{PROFESSOR_ACTOR}: De nada. Fico feliz que você me veja como um adulto confiável e eu possa ter ajudado, {PLAYER_ACTOR}! 
...
{PROFESSOR_ACTOR}: Até amanhã, {PLAYER_ACTOR}!
