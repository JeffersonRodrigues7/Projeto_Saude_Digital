...
{NPC_NAME}: Digo...
{NPC_NAME}: Olá!? Quem é?
{PLAYER_ACTOR}: Oi professor Rogério, aqui é o {PLAYER_ACTOR}.
{NPC_NAME}: Oh sim! {PLAYER_ACTOR}! O que você faz aqui?
{PLAYER_ACTOR}: Bom... eu estava conversando com a professora {PROFESSOR_ACTOR}, e ela parecia estar com bastante fome.
...
{NPC_NAME}: Bom {PLAYER_ACTOR}, é uma situação um pouco embaraçosa, mas eu meio que estou preso dentro de casa no momento. Se não fosse isso eu já teria levado o almoço dela faz tempo.
...
{NPC_NAME}: {PLAYER_ACTOR}, você poderia dar uma passada no parque e ver se eu deixei a chave cair lá?
...
{NPC_NAME}: Muito obrigado {PLAYER_ACTOR}!
